...
// 해석은 PDF에서 가져오고, AI는 18~45번 풀이/Words를 보완한다.
const PYUNGWON_RANGES = [[18, 45]] as const
...
export async function POST(
  ...
  // 학평/평가원 공통: 18~45번 AI 보완 (출제의도/해석은 보존)
  ...
  for (const g of generated) {
    ...
    // PDF에서 가져온 출제의도/해석은 보존하고, AI는 풀이/Words만 보완한다.
    const updateFields = {
      explanation_solution: g.solution || null,
      explanation_vocabulary: vocabulary,
    }
