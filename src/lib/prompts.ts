...
Step 0 [단어·구 단답형 즉시 판정]:
  모범답안이 단어 또는 짧은 구(3단어 이하)인 경우:
  - 학생 답안을 공백·대소문자 무시 후 비교
  - 일치하면 즉시 is_correct: true (아래 Step 1~4 적용하지 않음)
  - 불일치하면 즉시 is_correct: false
  예) 모범답안 "watching", 학생 답안 "watching" → true
  예) 모범답안 "had", 학생 답안 "have" → false
